...
<p align="center">
	<img width=500, src="212.png"> <br />
	<em>
		Figure 2: (a) Spatial-Frequency Dual-Domain Network (SFUNet) Comprising frequency-domain branch F-UNet and spatial-domain branch S-UNet, primarily extracting features via RFFT blocks and Residual Blocks (RB\cite{FCBSwinV2}).(b) Residual Fast Fourier Transform Block (RFFT) Extracts frequency-domain features through Fast Fourier Transform (FFT) with dynamic residual connections governed by learnable parameter $\gamma$.(c) Spatial-Frequency Attention Assembly (SFAA) Fuses frequency/spatial domain weights using attention maps generated by Global Average Pooling (GAP) and Global Maximum Pooling (GMP).
	</em>
</p>
## 2. Usage
...
<p align="center">
	<img width=500, src="直观分割图.png"> <br />
	<em>
		Figure 3: Five polyp samples with ambiguous boundaries, cluttered backgrounds, or small sizes were selected for comparison. SwinV2-SF outperforms six benchmarks by precisely delineating polyp edges and segmenting small polyps in complex environments.
	</em>
</p>
